...
const CartItemRow = ({ item }: { item: { product: any; quantity: number } }) => {
      ...
      <div className="container py-8 md:py-12">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <button onClick={clearCart} className="mt-4 text-sm text-muted-foreground underline hover:text-foreground">
              Clear cart
            </button>
          </div>
